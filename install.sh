...
url_izin="https://raw.githubusercontent.com/PetrukTunnel/vps_access/main/ip"
...
INSTALL_WEBSOCKET() {
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/ws/install-ws.sh && chmod +x install-ws.sh && ./install-ws.sh
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/ws/banner_ssh.sh && chmod +x banner_ssh.sh && ./banner_ssh.sh
}

INSTALL_BACKUP() {
apt install rclone
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://github.com/PetrukTunnel/v7/raw/main/rclone.conf"
...
INSTALL_OHP() {
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/ws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
}

INSTALL_FEATURE() {
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/menu/install_menu.sh && chmod +x install_menu.sh && ./install_menu.sh
}

INSTALL_UDP_CUSTOM() {
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/ws/UDP.sh && chmod +x UDP.sh && ./UDP.sh
}
...
NEW_FILE_MAX=65535  # Atur sesuai kebutuhan Anda
...
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/install_cron.sh && chmod +x install_cron.sh && ./install_cron.sh
clear
}
...
echo -e "\e[91;1m ================================ \e[0m"
cd
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/PACKAGES/tools.sh && chmod +x tools.sh && ./tools.sh
wget -q -O /etc/port.txt "https://raw.githubusercontent.com/PetrukTunnel/v7/main/PACKAGES/port.txt"
...
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
# limit quota & service xray
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/Xbw_LIMIT/install.sh && chmod +x install.sh && ./install.sh
clear
# limit service ip xray
wget https://raw.githubusercontent.com/PetrukTunnel/v7/main/AUTOKILL_SERVICE/service.sh && chmod +x service.sh && ./service.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/PetrukTunnel/v7/main/versi  )
...
# buat profile / memunculkan tampilan halaman awal menu script
cat> /root/.profile << END
if [ "$BASH" ]; then
if [ -f ~/.bashrc ]; then
. ~/.bashrc
